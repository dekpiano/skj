...
<head>
    <meta charset="UTF-8">
    <title>เนื่องในวันคล้ายวันพระราชสมภพ 5 ธันวาคม </title>
    ...
    <meta property="og:title"
        content="เนื่องในวันคล้ายวันพระราชสมภพ 5 ธันวาคม">
    <meta property="og:description"
        content="ด้วยเกล้าด้วยกระหม่อม ขอเดชะ ข้าพระพุทธเจ้า ผู้บริหาร คณะครู บุคลากรทางการศึกษา นักเรียนและผู้ปกครอง  โรงเรียนสวนกุหลาบวิทยาลัย (จิรประวัติ) นครสวรรค์">
    <meta property="og:type" content="website">
    <meta property="og:image" content="https://skj.ac.th/uploads/video/r9-5.png">
...
<body>
    <div class="con-video">
        <video poster="<?= base_url('uploads/video/poster_day5.webp') ?>"  autoplay muted="muted" loop="loop" class="video-con">
    ...
    <div id="main">
        <div style="align-self: center;text-align: center;">
            <img class="img-fluid " data-aos="zoom-in-down" data-aos-delay="50" data-aos-offset="200"
                data-aos-duration="500" src="<?= base_url(
                'uploads/video/r9-5.png'
            ) ?>" alt="">
            <div style="text-align: center;">
                <h2 data-aos="zoom-in" data-aos-delay="500">
                    เนื่องในวันคล้ายวันพระราชสมภพ 5 ธันวาคม <br>
                </h2><br>
            ...
            <div style="text-align-last: center;">
                <button onclick="sigewebsite()" class="golden-btn fade-in" 
