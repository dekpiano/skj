...
class Control_guidance extends CI_Controller {
	protected $DBPers;
	...
	public static $title = "ทุนการศึกษา";
	public static $description = "ทุนการศึกษา";
	...
	public function guidance_main()
	{
		...
		$this->load->view('user/guidance/guidance_main.php');
